...
public class BreqkWidgetProvider extends AppWidgetProvider {
    ...
    /** Log tag — filter with: adb logcat -s BreqkWidget */
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // Deep link URI: breqk://browser/instagram
        ...
        Intent instagramIntent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("breqk://browser/instagram"));
        ...
        PendingIntent instagramPending = PendingIntent.getActivity(
                ...
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        Log.d(TAG, "onUpdate: Instagram deep link PendingIntent created (breqk://browser/instagram)");

        // --- Create PendingIntent for YouTube icon (opens distraction-free browser) ---
        // Deep link URI: breqk://browser/youtube
        ...
        Intent youtubeIntent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("breqk://browser/youtube"));
        ...
        PendingIntent youtubePending = PendingIntent.getActivity(
                ...
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        Log.d(TAG, "onUpdate: YouTube deep link PendingIntent created (breqk://browser/youtube)");
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            // Inflate the widget layout (res/layout/widget_breqk.xml)
