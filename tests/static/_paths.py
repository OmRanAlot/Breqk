...
BREQK_PREFS    = JAVA_SRC / "prefs" / "BreqkPrefs.java"
...
ACCESSIBILITY_FILTER_CONFIG = ANDROID_SRC / "res" / "xml" / "content_filter_accessibility_config.xml"
WIDGET_INFO_XML             = ANDROID_SRC / "res" / "xml" / "widget_breqk_info.xml"
